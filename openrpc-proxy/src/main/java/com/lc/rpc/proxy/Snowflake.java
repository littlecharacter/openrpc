...
public final class Snowflake {
    private final long baseTimestamp = LocalDateTime.of(2023, 1, 1, 0, 0, 0).atZone(ZoneId.systemDefault()).toInstant().toEpochMilli();
    ...
    public static Snowflake instance() {
        return SnowflakeInner.instance;
    }

    private static class SnowflakeInner {
        static Snowflake instance = new Snowflake();
    }

    public long getId() {
        return this.getId(1,1);
    }
